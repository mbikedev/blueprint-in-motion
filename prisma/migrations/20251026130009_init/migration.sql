-- CreateEnum
CREATE TYPE "MembershipTier" AS ENUM ('INITIATION', 'COMMITMENT');

-- CreateEnum
CREATE TYPE "MembershipStatus" AS ENUM ('ACTIVE', 'CANCELLED', 'EXPIRED', 'PAUSED');

-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('TEXT', 'VIDEO', 'AUDIO', 'IMAGE');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COMMENT', 'MENTION', 'PAYMENT', 'ANNOUNCEMENT', 'SYSTEM');
