    ...
    <main className="min-h-screen">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="font-oswald text-5xl mb-6">From Survival to Legacy</h2>
          ...
          <div className="flex justify-center items-center gap-8 mb-12">
            <div className="text-center">
              ...
              <h3 className="font-oswald text-2xl mb-2">Survival</h3>
              <p className="text-gray-600">Where you are</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-oswald text-2xl mb-2">Growth</h3>
              <p className="text-gray-600">The journey</p>
            </div>
            <div className="hidden md:block">
              <svg className="w-32 h-8" viewBox="0 0 100 20" fill="none">
                <path d="M0 10 L90 10" stroke="#2563eb" strokeWidth="2" strokeDasharray="4 4"/>
            ...
            <div className="text-center">
              ...
              <h3 className="font-oswald text-2xl mb-2">Legacy</h3>
              <p className="text-gray-600">Your destination</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-oswald text-4xl text-center mb-4">The Seven Dimensions</h2>
            ...
            {dimensions.map((dimension) => (
              ...
              >
                ...
                <div className="relative p-6">
                  ...
                  <div className="flex items-center text-bim-blue font-semibold group-hover:translate-x-2 transition-transform">
              ...
              <div className="relative p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="font-oswald text-2xl">The Blueprint</h3>
                  </div>
                </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-bim-blue to-blue-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-oswald text-4xl mb-6">Ready to Build Your Legacy?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/labs"
              className="bg-white text-bim-blue px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-lg"
            >
              Explore BIM-Labs
            </Link>
            <Link
